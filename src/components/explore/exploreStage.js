export const initialState = {
  ...
  export const AFTER_INITIAL_LOADING = 'Explore/AFTER_INITIAL_LOADING';
  export const DATA_LOADING = 'Explore/DATA_LOADING';
  export const UPDATE_IMPORTFROM = 'Explore/UPDATE_IMPORTFROM';
  export const FACET_VALUE_CHANGED = 'Explore/FACET_VALUE_CHANGED';
  export const DASHBOARD_DATA_CHANGED = 'Explore/DASHBOARD_DATA_CHANGED';
