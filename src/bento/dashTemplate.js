...
export const facetsParticipantsConfig = [
  ...
  {
    section: SAMPLES,
    label: 'Tumor Spatial Extent',
    apiPath: 'participantCountByTumorSpatialExtent',
    apiForFiltering: 'filterParticipantCountByTumorSpatialExtent',
  ...
  },
  {
    section: STUDY,
    label: 'Study Phase',
    apiPath: 'participantCountByStudyPhase',
    apiForFiltering: 'filterParticipantCountByStudyPhase',
...
export const facetsExploreFilesConfig = [
  {
    ...
    apiForFiltering: 'filterFileCountByDataCategory',
  ...
  },
  {
    ...
    apiForFiltering: 'filterFileCountByFileType',
    datafield: 'file_type',
    field: GROUP,
    type: InputTypes.CHECKBOX,
    sort_type: sortType.ALPHABET,
  ...
  },
  {
    ...
    apiForFiltering: 'filterFileCountByFileMappingLevel',
