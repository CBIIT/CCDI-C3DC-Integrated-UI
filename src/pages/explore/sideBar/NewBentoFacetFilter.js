...
import { facetsExploreFilesConfig as facetsConfig, facetSectionVariablesExploreFiles as facetSectionVariables, resetIcon, sectionLabel, queryParams } from '../../../bento/dashTemplate';
...
const { SearchBox } = SearchBoxGenerator({
  ...
  functions: {
    updateBrowserUrl: (query, navigate, newUniqueValue) => {
      ...
      navigate(`/exploreFiles${queryStr}`);
    },
