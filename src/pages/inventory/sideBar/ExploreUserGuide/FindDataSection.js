      ...
      <ul>
        ...
        <li>
          ...
          <ol className={classes.alphaList}>
            <li>“Participants”: Characteristics of a participant in the Explore Dashboard. Participants belong to a study, and they may have one or more samples, diagnoses, or files associated with them. Participant mappings from the <a href="https://ccdi.cancer.gov/ccdi-participant-index" className={classes.link} target="_blank" rel="noopener noreferrer">CCDI Participant Index (CPI)</a> have a summary of these mappings available from the table, and full mapping details are available by clicking on the adjacent icon.</li>
